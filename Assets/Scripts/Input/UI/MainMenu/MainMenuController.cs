...
public class MainMenuController : MonoBehaviour
{
    ...
    private void HandlePointer()
    {
        ...
        pointerPosition += pointerDirection * (500f* pointerSpeed * Time.deltaTime);//But Jhonny, conmutative property for multiplication. Why between parenthesis? because this way we multiply by a float twice instead of 6 times (without parenthesis). This is how Vector2 works.
